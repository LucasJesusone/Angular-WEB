...
<<<<<<< HEAD:src/app/pages/user/change-password/change-password.component.ts
...
>>>>>>> da3c7bbfbbcb673e0f64e39984ed79699f2b3cb3:src/app/pages/Usuarios/change-password/change-password.component.ts
import {
  FormBuilder,
  FormControl,
  FormGroup,
